...
<section class="text-center mb-8 md:mb-12">
    ...
    <div class="flex flex-wrap justify-center gap-3 md:gap-4">
        ...
        <div class="group category-tab <?= $index === 0 ? 'active' : '' ?> px-4 md:px-6 py-3 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all transform hover:scale-105" data-section="<?= strtolower(str_replace(['-', ' '], '', $ps['slug'])) ?>">
